...
function createOrderGrnTable(order_details){
    ...
    order_details.forEach(function(order) {
        ...
        var row = `<tr>
            ...
            <td class="text-center">
                <input type="text" readonly class="form-control bg-white text-center" style="background-color: #dbeff1 !important;"  value="${order.show_order_quantity || ''}"><input type="hidden" id="order_qty"  name="order_qty[]" value="${order.order_quantity || ''}">
            </td>
...
function createStockReturnGrnTable(stock_return_details){
    ...
    stock_return_details.forEach(function(stock) {
        ...
        var row = `<tr>
            ...
            <td class="text-center">
                <input type="text" readonly class="form-control bg-white text-center w-120"  style="background-color: #dbeff1 !important;" value="${stock.show_qty || ''}"><input type="hidden"  id="order_qty" name="stock_return_qty[]" value="${stock.qty || ''}">
            </td>
