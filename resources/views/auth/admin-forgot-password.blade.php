...
<body>
    ...
    <div class="forgetPassword_page">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12 form-detail">
                    <div class="form-forget">
                        ...
                        <div class="inner-form">
                            <form action="{{ route('admin.forgot-password.submit') }}" method="post" name="form-forget" id="form-forget">
                                ...
                                <div class="form-field">
                                    <input type="number" name="first_number" value="{{$number_first}}" class="count_first">
                                    <span>+</span>
                                    <input type="number" name="second_number" value="{{$number_second}}" class="count_snd">
                                    <span>=</span>
