                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4">
                                    <select id="product_uom" name="product_uom" class="form-select">
                                        ...
                                        @foreach($uoms as $uom)
                                            <option value="{{ $uom->id }}" {{ $product->uom == $uom->id ? 'selected' : '' }}>
                                                {{ $uom->uom_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-9">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input domestic" type="radio"
                                            name="product_country_origin" id="domestic" value="domestic" {{ $product->product_country_origin == 'domestic' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="domestic">India</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input international" type="radio"
                                            name="product_country_origin" id="international" value="international" {{ $product->product_country_origin == 'international' ? 'checked' : '' }}>
