<div class="sidebar-menu-list accordion custom-toggle-accordion" id="sidebarAccordion">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
            <div class="accordion-body">
                <ul class="accordian-submenu">
                    ...
                    <li><a href="{{ route("buyer.rfq.sent-rfq") }}">Sent RFQ</a></li>
                    ...
                    <li><a href="{{route('buyer.rfq.pi-invoice')}}"> PI's / Invoices </a></li>
                </ul>
            </div> 
        </div>
    </div>
    ...
    <div>
        <a href="{{ route('buyer.inventory.index') }}" class="menu-text-colour submenu-list">
        ...
        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo">
            <div class="accordion-body">
                <ul class="accordian-submenu" aria-labelledby="headingTwo">
                    ...
                    <li><a href="{{ route("buyer.setting.change-password") }}">Change Password</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix">
            <div class="accordion-body">
                <ul class="accordian-submenu" aria-labelledby="headingSix">
                    <li><a href="{{ route("buyer.user-management.users") }}">Manage Users</a></li>
                    <li><a href="{{ route("buyer.role-permission.roles") }}">Manage Role</a></li>
                </ul>
            </div>
        </div>
    </div>
