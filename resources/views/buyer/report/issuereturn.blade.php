...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="table-responsive table-inventory">
                <table class="product-listing-table w-100 dataTables-example1"  id="report-table">
                    <thead>
                        <tr>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Issued Return Number</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:225px;">Product Name</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:225px;">Our Product Name</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:150px;">Specification</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Size</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Inventory Grouping</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Issued Return Type</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Added BY</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Added Date</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Quantity</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">UOM</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom" style="width:125px;">Remarks</th>
                        </tr>
                    </thead>
                </table>
            </div>
    ...
    @push('exJs')
        @once
            <script>
                const getissuedReturnlistdataUrl              =   "{{ route('buyer.report.issuedReturnlistdata') }}";
                const getIssuedReturnExportUrl              =   "{{ route('buyer.report.issuedReturnExport') }}";
                const deleteExcelUrl="{{route('buyer.delete.export.file')}}";
                const exportTotalIssueReturnUrl              =   "{{ route('buyer.report.exportTotalIssueReturn') }}";
                const exportBatchIssueReturnUrl              =   "{{ route('buyer.report.exportBatchIssueReturn') }}";
            </script>
