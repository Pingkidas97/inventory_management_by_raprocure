         ...
         @once
            ...
            <script>
                $(document).ready(function() {
                    $('#export').on('click', function() {
                        const exporter = new Exporter({
                            ...
                            headers: ['Serial Number','Branch','Order Number','Order Date','Product Name','Vendor Name','Added BY','Order Value','Status'],
                            totalUrl: "{{ route('buyer.report.manualPO.exportTotal') }}",
                            batchUrl: "{{ route('buyer.report.manualPO.exportBatch') }}",
                            token: "{{ csrf_token() }}",
                            exportName: "Manual_PO_Report_",
                            expButton: '#export',
                            ...
                            getParams: function() {
                                $('#search_product_name, #search_category_id, #from_date, #search_order_no, #search_vendor_name, #order_status, #to_date, #branch_id').prop('disabled', true);
                ...
                function enableFilters() {
                    $('#export-progress').hide();
                    $('#search_product_name, #search_category_id, #from_date, #search_order_no, #search_vendor_name, #order_status, #to_date, #branch_id')
                        .prop('disabled', false);
