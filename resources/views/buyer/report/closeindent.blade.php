...
@section('content')
    ...
    @push('exJs')
        @once
            <script>
                const closeindentreportlistdataurl        =   "{{ route('buyer.report.closeindentlistdata') }}";
                const exportreportlistcloseindenturl      =    "{{ route('buyer.report.exportcloseIndentReport') }}";
                const opentdcloseindenturl                =    "{{ route('buyer.report.closeindentdata') }}";
                const deleteExcelUrl="{{route('buyer.delete.export.file')}}";
                const exportTotalcloseindentdataUrl      =    "{{ route('buyer.report.exportTotalcloseindentdata') }}";
                const exportBatchcloseindentdataUrl      =    "{{ route('buyer.report.exportBatchcloseindentdata') }}";
            </script>
