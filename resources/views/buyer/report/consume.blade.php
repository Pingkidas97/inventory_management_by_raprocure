    ...
    <div class="card rounded">
        ...
        <div class="card-header bg-white">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h1 class="font-size-22 mb-0">Consume Report</h1>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 pt-3 mb-3">
                ...
                <div class="col-6 col-sm-4 col-md-4 col-lg-2 mb-3">
                    <div class="input-group">
                        ...
                        <div class="form-floating">
                            ...
                            <label for="from_date">From Added Date</label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control dateTimePickerEnd" name="to_date" id="to_date"
                                placeholder="To Date">
                            <label for="to_date">To Added Date</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-sm-auto">
                    <button type="button"
                        class="ra-btn ra-btn-outline-danger w-100 justify-content-center font-size-11" onClick="window.location.href='{{ route('buyer.report.consume') }}'">
            ...
            <div class="table-responsive table-inventory">
                <table class="product-listing-table w-100 dataTables-example1"  id="report-table">
                    <thead>
                        <tr>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Consume Number</th>
                            ...
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Issued Qty</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Consumed Qty</th>
                            <th class="text-center border-bottom-dark text-wrap keep-word align-bottom">Consumed Amount</th>
            ...
            <script>
                ...
                function report_list_data() {
                    $('#report-table').DataTable({
                        ...
                        ajax: {
                            url: "{{ route('buyer.report.consume.listdata') }}",
                            data: function (d) {
                ...
                $(document).ready(function() {
                    $('#export').on('click', function() {
                        const exporter = new Exporter({
                            ...
                            headers: ['Branch', 'Product', 'Our Product Name', 'Specification','Size','Inventory Grouping','Cost Center','Consuume No', 'Issued No', 'Issued Qty','Consume Qty','Added Date'],
                            totalUrl: "{{ route('buyer.report.consume.exportTotalConsume') }}",
                            batchUrl: "{{ route('buyer.report.consume.exportBatchConsume') }}",
                            token: "{{ csrf_token() }}",
                            exportName: "Consume_Report_",
                            expButton: '#export',
